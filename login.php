  ...
  <div class="container-login100" style="background-image: url('page/images/bg.jpg');">
    <div class="wrap-login100 p-l-55 p-r-55 p-t-40 p-b-10">
      <form action="op.php" method="post" class="login100-form validate-form">
        ...
        <div class="container-user100-form-btn">
          <a href="login_admin" style="color: white" class="user100-form-btn">
            ADMIN
          </a>
        </div>
        ...
        <div class="container-user100-form-btn">
          <a href="login_pengelola" style="color: white" class="user100-form-btn">
            PENGELOLA
          </a>
        </div>
