	...
	if(!isset($_POST["checkbox"])){
		$checkbox = '1';
          ...
          <div class="box-header with-border">
            ...
            <!-- /.box-body -->
            <div class="box-footer">
              <button type="submit" class="btn btn-success pull-right btn-flat" name="simpan2"><span class="glyphicon glyphicon-floppy-disk"></span> Simpan</button>
            </div>
            <!-- /.box-footer -->
          </form>
    <?php
