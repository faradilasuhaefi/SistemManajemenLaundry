...
<?php } ?>
        ...
        <div class="row">
           <div class="form-group col-md-12 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="password" class="form-control" id="password" name="password" placeholder="Masukan Password" maxlength="50" required autocomplete="off">
                  </div>
                </div>
        </div>
<?php if($no != null || $no != ""){}else{ ?>
        <div class="row">
           <div class="form-group col-md-12 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="password" class="form-control" id="password2" name="password2" placeholder="Masukan Password Lagi" maxlength="50" required autocomplete="off">
                  </div>
                </div>
        </div>
<?php } ?>
         <div class="row">
                <div class="form-group col-md-12 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>"  placeholder="Masukan Nama lengkap" maxlength="100" required autocomplete="off">
                  </div>
                </div>
        </div>
        ...
        <div class="row">
               <div class="form-group col-md-12 col-xs-12" >
                 ...
                 <div class="col-sm-9">
                   <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $alamat; ?>"  placeholder="Masukan Alamat " maxlength="255" autocomplete="off">
                 </div>
               </div>
       </div>
       ...
       <div class="row">
              <div class="form-group col-md-12 col-xs-12" >
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="nohp" name="nohp" value="<?php echo $nohp; ?>"  placeholder="Masukan Nomor Handphone" maxlength="20" autocomplete="off">
                </div>
              </div>
      </div>
...
<?php if($_SESSION['jabatan'] == 'admin'){ ?>
      <div class="row">
             <div class="form-group col-md-12 col-xs-12" >
               ...
               <div class="col-sm-9">
                 <select class="form-control select2" style="width: 100%;" name="jabatan" required autocomplete="off">
          <?php
...
<?php } ?>
  ...
  <div class="box-footer">
    <div class="row">
      <div class="col-sm-13 border-right">
