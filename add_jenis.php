   ...
   <div class="container-fluid">
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Masukan Nama Jenis Layanan" maxlength="50" required autocomplete="off">
                  </div>
                </div>
        </div>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="biaya" name="biaya" value="<?php echo $biaya; ?>" placeholder="Masukan Biaya Jenis Layanan" maxlength="20" required autocomplete="off">
                  </div>
                </div>
        </div>
