...
if($chmenu2 >= 1 || $_SESSION['jabatan'] == 'admin'){ ?>
                        ...
                        <li class="treeview">
                            <a href="#"> <i class="glyphicon glyphicon-folder-close"></i> <span>Member</span> <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i> </span> </a>
							 <ul class="treeview-menu">
                                <li>
                                    <a href="pelanggan"><i class="fa fa-circle-o"></i>Data Member</a>
                                </li>
<li>
                                    <a href="add_pelanggan"><i class="fa fa-circle-o"></i>Tambah Member</a>
                                                  </li>
                            </ul>
                        </li>
...
<?php }else{}
  if($chmenu1 >= 1 || $_SESSION['jabatan'] == 'admin'){ ?>
                          ...
                          <li class="treeview">
                            <a href="#"> <i class="glyphicon glyphicon-user"></i> <span>Pegawai</span> <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i> </span> </a>
               <ul class="treeview-menu">
                                <li>
                                    <a href="admin"><i class="fa fa-circle-o"></i>Data Pegawai</a>
                                </li>
<li>
                                    <a href="add_admin"><i class="fa fa-circle-o"></i>Tambah Pegawai</a>
                                                  </li>
                            </ul>
                        </li>
  ...
  if($chmenu9 >= 1 || $_SESSION['jabatan'] == 'admin'){ ?>
                          ...
                          <li class="treeview">
                            <a href=""> <i class="glyphicon glyphicon-cog"></i> <span>Pengaturan</span> <span class="pull-right-container"> </span> </a>
                            	 <ul class="treeview-menu">
                                <li>
                                    <a href="set_general"><i class="fa fa-circle-o"></i>Pengaturan Umum</a>
                                </li>
								<li>
								<a href="set_themes"><i class="fa fa-circle-o"></i>Pengaturan Tema</a>
                               </li>
                               	<li>
                 								<a href="add_jabatan"><i class="fa fa-circle-o"></i>Pengaturan Pengguna</a>
                                                                   </li>
								<li>
