...
?>
 <li> <a href="<?php echo $halaman;?>" style="color: #086e26">Data <?php echo $dataapa ?></a></li>
  <li class="active"><?php
    echo $search;
?></li>
  <?php
	 ...
	 <div class="container-fluid">
          ...
          <form class="form-horizontal" method="post" action="add_<?php echo $halaman; ?>" id="Myform">
              <div class="box-body">
				...
				<div class="row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Masukan Nama Keperluan" maxlength="100" required autocomplete="off">
                  </div>
                </div>
				</div>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="biaya" name="biaya" value="<?php echo $biaya; ?>" placeholder="Masukan Biaya" maxlength="50" required autocomplete="off">
                  </div>
                </div>
        </div>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control pull-right" id="datepicker2" name="tanggal" placeholder="Masukan Tanggal" value="<?php echo $tanggal; ?>" required autocomplete="off">
                  </div>
                </div>
        </div>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                  <textarea class="form-control" rows="3" id="keterangan" name="keterangan" maxlength="255" placeholder="Masukan Keterangan" autocomplete="off"><?php echo $keterangan; ?></textarea>
                   </div>
                </div>
        </div>
