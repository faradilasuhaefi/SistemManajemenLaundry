...
<ol class="breadcrumb ">
<li><a href="<?php echo $_SESSION['baseurl']; ?>" style="color: #086e26">Dashboard </a></li>
<li><a href="<?php echo $halaman;?>" style="color: #086e26"><?php echo $dataapa ?></a></li>
<?php
...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
    ...
    <!----------------KONTEN------------------->
	  ...
	  $kode=$nama=$jeniskelamin=$tgldaftar=$alamat=$nohp="";
	  $no = $_GET["no"];
	  $insert = '1';
	...
	<div id="main">
	 <div class="container-fluid">
          ...
          <form class="form-horizontal" method="post" action="add_<?php echo $halaman; ?>" id="Myform">
			  ...
			  <div class="row">
                <div class="form-group col-md-6 col-xs-12" >
                  <label for="kode" class="col-sm-3 control-label">Kode Member:</label>
                  <div class="col-sm-9">
                   <?php  if($no == null || $no ==""){ ?>
				...
				<div class="row">
				   <div class="form-group col-md-6 col-xs-12" >
                  <label for="nama" class="col-sm-3 control-label">Nama Member:</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Masukan Nama Member" maxlength="50" required autocomplete="off">
                  </div>
                </div>
				</div>
        ...
        <div class="row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="jeniskelamin" name="jeniskelamin" value="<?php echo $jeniskelamin; ?>" placeholder="Masukan Jenis Kelamin" maxlength="50" required autocomplete="off">
                  </div>
                </div>
				</div>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nohp" name="nohp" value="<?php echo $nohp; ?>" placeholder="Masukan Nomor Handphone" maxlength="50" required autocomplete="off">
                  </div>
                </div>
        </div>
				...
				<div class="row">
                  ...
                  <div class="col-sm-9">
                  <textarea class="form-control" rows="3" id="alamat" name="alamat" maxlength="255" placeholder="Masukan Alamat" required autocomplete="off"><?php echo $alamat; ?></textarea>
                   </div>
                </div>
				</div>
			...
			<input type="hidden" class="form-control" id="insert" name="insert" value="<?php echo $insert;?>" maxlength="1" >
              ...
              <div class="box-footer" >
                <button type="submit" class="btn btn-success pull-left btn-flat" name="simpan" onclick="document.getElementById('Myform').submit();" ><span class="glyphicon glyphicon-floppy-disk"></span> Simpan</button>
              </div>
              <!-- /.box-footer -->
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
              ...
              if(mysqli_num_rows($result)>0){
                  ...
                  $sql1 = "update $tabeldatabase set nama='$nama',jeniskelamin='$jeniskelamin',nohp='$nohp',alamat='$alamat' where kode='$kode'";
          ...
          echo "<script type='text/javascript'>window.location = '$forwardpage';</script>";
					 ...
					 $sql2 = "insert into $tabeldatabase values( '$kode','$tgldaftar','$nama', '$jeniskelamin','$alamat','$nohp','')";
