...
<div class="col-lg-12">
  ...
  <li><a href="" style="color: #086e26"><?php echo $dataapa ?></a></li>
  <?php
              ...
              <div class="box-body">
                ...
                <div class="row">
                        <div class="form-group col-md-7 col-xs-12" >
                          ...
                          <div class="col-sm-9">
                           <?php  if($no == null || $no ==""){ ?>
                            <input type="text" class="form-control" id="kode" name="kode" value="<?php echo autoNumber(); ?>" maxlength="20" required autocomplete="off">
                          <?php }else{ ?>
				...
				<div class="row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Masukan Jabatan" maxlength="20" required="" autocomplete="off">
                  </div>
                </div>
				</div>
...
?>
 ...
 <?php
    ...
    ?>
               ...
               <input type="text" name="search" class="form-control pull-right" placeholder="Cari" autocomplete="off">
