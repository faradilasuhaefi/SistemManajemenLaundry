    ...
    <div class="wrap-login100 p-l-55 p-r-55 p-t-40 p-b-10">
      <form action="op.php" method="post" class="login100-form validate-form">
        ...
        <span class="login100-form-subtitle p-b-10">
         <b>Halaman Login Pengelola</b></a>
        </span>
        </div>

        <div class="wrap-input100 validate-input m-b-20" data-validate="Masukan username">
          <input class="input100" type="text" name="txtuser" placeholder="Username" autocomplete="off">
          <span class="focus-input100"></span>
        </div>

        <div class="wrap-input100 validate-input m-b-25" data-validate = "Masukan password">
          <input class="input100" type="password" name="txtpass" placeholder="Password" autocomplete="off">
          <span class="focus-input100"></span>
        </div>
        ...
        <div class="container-login100-form-btn">
          <a href="cek" style="color: white" class="login100-form-btn">
            Cek Status Cucian
          </a>
        </div>
