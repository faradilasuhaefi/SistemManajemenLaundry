...
?>
                ...
                <input type="text" class="form-control" id="jumlah" name="jumlah" autocomplete="off" value="<?php echo $jumlah; ?>" placeholder="0" onkeyup="sum();">
              </div>
                            ...
                            <div class="row" >
                              <div class="col-md-12">
                                <div class="box" >
                                       ...
                                       if (!$(total).val()){
                                         document.getElementById('kembalian').value = "0";
                                                      ...
                                                      <div class="col-sm-2">
                                                        ...
                                                        <input type="text" class="form-control" id="jamdeadline" name="jamdeadline" value="<?php echo $jamdeadline; ?>" maxlength="5" placeholder="<?php echo date("H:i");?>" autocomplete="off">
                                                      </div>

                                                      <div class="col-sm-3">
                                                        <label for="usr">Catatan</label>
                                                        <input type="text" class="form-control" id="catatan" name="catatan" value="<?php echo $catatan; ?>" placeholder="Masukan Catatan" maxlength="255" autocomplete="off">
                                                      </div>
                                  ...
                                  <div class="col-sm-2">
                                  <label for="usr" style="color:transparent">.</label>
                                  <button type="submit" class="btn btn-block pull-left btn-success" name="simpan" onclick="document.getElementById('Myform').submit();" >Proses Order</button>
                                </div>
